<?php
  ...
  */
  class TOC_Purchase extends Controller
  {
    ...
    */
    ...
    public function repeat_purchase()
    {
        ...
        */
        ...
        if(!isset($_GET['user_id'])) {
          Flash::set("Invalid Request, a user must be set" , 'danger');
          return redirect('/FNUserSteps/get_position1');
        }
        ...
        */
        ...
        return $this->view('product_advance/repeat_purchase' , $data);
    }
    ...
    public function make()
    {
      ...
      */
      ...
      $this->toc->moveToNextStep($purchaser->id, $stockTransactions['release']);
