	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
							...
							<form method="post" action="/AccountProfile/update_address"  autocomplete="off">

								<h3><?php Flash::show();?></h3>

								<input type="hidden" name="old_address" value="<?php echo $old_address;  ?>">

								<?php if($old_address == "not set"): ?>
								...
								<div class="wrap-input100 validate-input m-b-16" data-validate = "Address is required">
									<input class="input100" type="text" autocomplete="off" name="house_st"  placeholder="House Number and Street" required> 
								...
								<div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="brgy"  placeholder=" Barangay" required >
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
			                    ...
			                    <br>
			                    <div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="city"  placeholder= "City" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
			                    ...
			                    <br>
			                    <div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" name="province"  placeholder=" Province" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
			                    ...
			                    <br>
			                    <div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="region" id="region_text"  placeholder="Region" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
