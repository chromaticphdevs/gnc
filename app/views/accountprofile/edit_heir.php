	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
							...
							<form method="post" action="/AccountProfile/edit_heir"  autocomplete="off">
								...
								<div class="wrap-input100 validate-input m-b-16" data-validate = "First Name is required">
									<input class="input100" type="text" autocomplete="off" name="firstname"  value="<?php echo $_GET['firstname']; ?>" required> 
								...
								<div class="wrap-input100 validate-input m-b-16" data-validate = "Middle Name is required">
									<input class="input100" type="text" autocomplete="off" name="middlename"  value="<?php echo $_GET['middlename']; ?>" required> 
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
								...
								<div class="wrap-input100 validate-input m-b-16" data-validate = "Last Name is required">
									<input class="input100" type="text" autocomplete="off" name="lastname"  value="<?php echo $_GET['lastname']; ?>" required> 
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
