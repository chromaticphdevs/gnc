      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main" style="min-height: 524px;">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form action="/FacebookStream/edit" method="post">
                        <input type="hidden" name="streamid" value="<?php echo $stream->id?>">
                        <div class="form-group">
                            <label for="#">Title</label>
                            <input type="text" class="form-control" name="title" placeholder="Your Stream Title" 
                            value="<?php echo $stream->title?>">
                        </div>
                        <div class="form-group">
                            <label for="#">Facebook Stream Link</label>
                            <input type="text" name="facebook_link" class="form-control" required 
                            value="<?php echo htmlentities(base64_decode($stream->facebook_link))?>">
                            <small><a href="#">How to start facebook live tuts.</a></small>
                        </div>

                        <div class="form-group">
                            <label for="#">Description</label>
                            <textarea name="description" class="form-control" rows="5"><?php echo $stream->description?></textarea>
                        </div>

                        <input type="submit" class="btn btn-primary btn-sm" value="Save Stream">
                    </form>
                </div>
            </div>
        </div>
