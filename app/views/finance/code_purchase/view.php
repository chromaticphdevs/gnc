                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <table class="table">
                        ...
                        <tr>
                          <td>Code (For Item Claiming)</td>
                          <td><strong><?php echo $codepurchase->reference?></strong></td>
                        </tr>
                        <tr>
                          <td>Branch</td>
                        ...
                        <tr>
                          <td>Amount</td>
                          <td><strong><?php echo $code->get_amount()?></strong></td>
                        </tr>

                        <tr>
                          <td>Box Equivalent</td>
                          <td><strong><?php echo $code->box_eq?></strong></td>
                        </tr>
                      </table>
                    </div>
