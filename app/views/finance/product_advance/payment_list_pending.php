 ...
 <?php $whirlpool="831a50be987979d6ee3658eb80f2d1ca8cd21023e90cbd6a98c6c8c0801d9b263d2da6a134a128f886d4cbd22bfbd455adce86b289876df4f7b9d6945c6bbbf4"; ?>
        ...
        <div class="right_col" role="main" style="min-height: 524px;">
            ...
            <?php Flash::show()?>
             ...
             <a class="btn btn-info btn-sm" href="/FNProductBorrower/get_payment_list_approved">Approved Payments List</a>
                                   ...
                                   <?php foreach($result as $data) :?>
                                      <tr>
                                            ...
                                            <td style="text-align: center;">         
                                                   ...
                                                   <a class="btn btn-success btn-sm" href="/FNProductBorrower/approve_payment/?code=<?php echo  $whirlpool.''.$whirlpool; ?>&loan_id=<?php echo $data->loanId; ?>&payment_id=<?php echo $data->id; ?>&userId=<?php echo $data->userId; ?>&loan_number=<?php echo $data->code; ?>&amount=<?php echo $data->amount; ?>&code2=<?php echo  $whirlpool.''.$whirlpool; ?>" id="release_product">&nbsp;Approve&nbsp;</a>

                                                   &nbsp;&nbsp;&nbsp;

                                                    <a class="btn btn-danger btn-sm" href="/FNProductBorrower/decline_payment/?code=<?php echo  $whirlpool.''.$whirlpool; ?>&payment_id=<?php echo $data->id; ?>&filename=<?php echo $data->image; ?>&code2=<?php echo  $whirlpool.''.$whirlpool; ?>" id="release_product">&nbsp;Decline&nbsp;</a>
                                            </td>                                                                      
                                      </tr>
                                    <?php $counter++;?>  
                                    <?php endforeach;?>
