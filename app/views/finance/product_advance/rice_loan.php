...
<body class="nav-md">
 ...
 <?php $whirlpool="831a50be987979d6ee3658eb80f2d1ca8cd21023e90cbd6a98c6c8c0801d9b263d2da6a134a128f886d4cbd22bfbd455adce86b289876df4f7b9d6945c6bbbf4"; ?>
        ...
        <div class="right_col" role="main" style="min-height: 524px;">
            ...
            <h3><?php echo 'Total: <b>'.to_number($total).'</b>'; ?></h3>
            <?php Flash::show()?>
            <?php Flash::show('purchase_message')?>

            <?php if($status == 'Paid'):?>
                <a class="btn btn-info btn-sm" href="/FNProductBorrower/get_released_rice/Approved">Pending Loan Client List</a>
            <?php else:?>
                <a class="btn btn-info btn-sm" href="/FNProductBorrower/get_released_rice/Paid">Paid Client List</a>
            <?php endif;?>
