			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
					...
					<?php if(isset($_GET['username'])): ?>
						...
						<div class="container-login100-form-btn p-t-25">
							...
							<!--<a class="login100-form-btn" href="/ActivationForm">
								OK
							</a>-->
				...
				<?php else: ?>
							...
							<form method="post" action="#" onSubmit = "return input_submit()" autocomplete="off">
								...
								<div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="religion_text" id="religion_text" placeholder="Religion" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-user"></span>
									</span>
								...
								<div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="" id="brgy_text" placeholder=" Barangay" required >
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
			                    ...
			                    <br>
			                    <div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="" id="city_text"  placeholder= "City" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
			                    ...
			                    <br>
			                    <div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="" id="region_text"  placeholder="Region" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
...
<!--===============================================================================================-->
	...
	<script> 
		...
		{	
			...
			$.ajax({
		      method: "POST",
		      url: '/ActivationForm/check_send_text_code',
		      data:{
		...
		function register_user()
		{
			...
			if(code != user_input)
			{
					...
					var e2 = document.getElementById("brgy_select");
