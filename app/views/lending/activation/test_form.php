			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				...
				<?php if(isset($_GET['username'])): ?>
						...
						<div class="container-login100-form-btn p-t-25">
							...
							<a class="login100-form-btn" href="/ActivationForm/test">
								OK
							</a>
				...
				<?php else: ?>
							...
							<form method="post" action="#" onSubmit = "return input_submit()" autocomplete="off">
								...
								<div class="wrap-input100 validate-input m-b-16" data-validate = "First name is required">
									<input class="input100" type="text" autocomplete="off" name="first_name" id="first_name" placeholder="First name" required> 
								...
								<div class="wrap-input100 validate-input m-b-16" data-validate = "Middle name is required">
									<input class="input100" type="text" autocomplete="off" name="middle_name" id="middle_name" placeholder="Middle name" required> 
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-user"></span>
									</span>
								...
								<div class="wrap-input100 validate-input m-b-16" data-validate = "Last name is required">
									<input class="input100" type="text"  autocomplete="off" name="last_name" id="last_name" placeholder="Last name" required> 
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-user"></span>
									</span>
								...
								<div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="religion_text" id="religion_text" onkeyup="search_data()" placeholder="Search Religion" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-user"></span>
									</span>
								...
								<div class="wrap-input100 validate-input m-b-16" data-validate = "Address is required">
									<input class="input100" type="text" autocomplete="off" name="house_st" id="house_st" placeholder="House Number and Street" required> 
									<span class="focus-input100"></span>
									<span class="symbol-input100">
								...
								<div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="" id="brgy_text" onkeyup="brgy_f()" placeholder="Search Barangay" required >
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
			                    ...
			                    <br>
			                    <div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="" id="city_text" onkeyup="city_f()" placeholder="Search City" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
			                    ...
			                    <br>
			                    <div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" name="" id="province_text" onkeyup="province_f()" placeholder="Search Province" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
			                    ...
			                    <br>
			                    <div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="" id="region_text" onkeyup="region_f()" placeholder="Search Region" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-layers"></span>
									</span>
								...
								<div class="wrap-input100 validate-input m-b-16" data-validate = "Valid email is required: ex@abc.xyz">
									<input class="input100" type="text" autocomplete="off" name="email" id="email" placeholder="Email" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
								...
								<div class="wrap-input100 validate-input m-b-16" data-validate = "Valid email is required: ex@abc.xyz">
									<input class="input100" type="text" autocomplete="off" name="username" id="username" placeholder="Username" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-user"></span>
									</span>
								...
								<div class="field">
					     		<label>Referral Name</label>     	
					      		<div class="wrap-input100 validate-input m-b-16" >
									<input class="input100" type="text" autocomplete="off" name="refer_name" id="refer_name" onkeyup="search_data_ref()" placeholder="Search Referral Name or Email" required>
									<span class="focus-input100"></span>
									<span class="symbol-input100">
										<span class="lnr lnr-user"></span>
									</span>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
		...
		<div class="wrap-input100 validate-input m-b-16" data-validate = "Valid email is required: ex@abc.xyz">
			<input size="20" maxlength="20" style="text-transform:uppercase" class="input100" type="text" autocomplete="off" name="confirm_code" id="confirm_code" placeholder="Code" required>
			<span class="focus-input100"></span>
			<span class="symbol-input100">
		...
		<input size="20" maxlength="20" style="text-transform:uppercase"  type="hidden" autocomplete="off" name="codecode" id="codecode" placeholder="Code" required>
...
<!--===============================================================================================-->
	...
	<script> 
			...
			$.ajax({
		      ...
		      success:function(response)
		      {
		       ...
		       console.log(response);
		      	...
		      	{	
		      		document.getElementById("codecode").value = response;
		...
		{
			var code = $("#codecode").val();
			var user_input = $("#confirm_code").val();
			...
			if(code != user_input)
			{
					...
					var e7 = document.getElementById("refer");
					var refer2 = e7.options[e7.selectedIndex].value;
					...
					$.ajax({
				      method: "POST",
				      url: '/ActivationForm/pre_register',
				      data:{
				      ...
				      success:function(response)
				      {
				       ...
				       console.log(response);
				      	if(response == "OKOK")
				      	{
				      		...
				      		window.location = get_url("/ActivationForm/?refferal_ID="+refer2+"&username="+username);
