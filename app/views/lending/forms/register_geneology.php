		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				...
				<?php else: ?>
							...
							<br>
							<a class="login100-form-btn" href="/users/login">
								LOGIN
							</a>
	...
	<script> 
		...
		{	
			...
			}else
			{
					...
					$.ajax({
				      method: "POST",
				      url: '/LDUser/pre_register_geneology',
				      data:{
				      ...
				      success:function(response)
				      {
				       ...
				       if(response == "OKOK")
				      	{
				      		window.location = get_url("/LDUser/pre_register_geneology/?refferal_ID="+refferal_ID+"&username="+username);
				      	}	
