			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				...
				<?php if(isset($_GET['username'])): ?>
						...
						<div class="container-login100-form-btn p-t-25">
							...
							<!--<a class="login100-form-btn" href="/LDUser/pre_register_right/?refferal_ID=<?php echo $_GET['refferal_ID']; ?>">
								OK
							</a>-->
			...
			}else
			{
					...
					$.ajax({
				      ...
				      success:function(response)
				      {
				       ...
				       if(response == "OKOK")
				      	{
				      		window.location = get_url("/LDUser/pre_register_right/?refferal_ID="+refferal_ID+"&username="+username);
				      	}	
