        ...
        <div class="col-md-12">
            ...
            <div class="table-responsive">
               ...
               <?php if(isset($level) && $level == 1 ): ?>
                 <form action="/NewUserFollowUps/getByAddress_sorted" method="post" enctype="multipart/form-data">

                      <div class="form-group">
                        <label for="#">Search Address</label>
                        <input type="text"  name="address" value="<?php echo Session::get('SEARCHDATA') ?? ""; ?>" class="form-control" required>
                      </div>
