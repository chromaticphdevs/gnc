<?php build('content') ?>
    ...
    <?php if(!empty(Session::get('SEARCHDATA'))):?>
        <a class="btn btn-danger btn-sm" href="/NewUserFollowUps/getByAddress">Back</a> 
    <?php else: ?>
        <a class="btn btn-danger btn-sm" href="/NewUserFollowUps/index?level=<?php echo $userLevel?>">Back to follow up</a> 
    <?php endif; ?>
    <a  class="btn btn-info btn-sm" href="/NewUserFollowUps/index?level=1">Follow up 1</a>
    <?php Flash::show()?>
    ...
    <table class="table">
        <tbody>
           ...
           <tr>
            ...
            <tr>
                <td>Username</td>
                <td> <span class="label label-info"><?php echo $user->username?></span> </td>
            </tr>
            <tr>
                <td>Phone</td>
            ...
            <tr>
                <td>ID Uploaded</td>
                <td>
                    <?php if(count($uploaded_id) > 0): ?>
                        <?php echo 'Has '.count($uploaded_id).' <span class="label label-success"> Verified ID'?></span>
                    <?php else: ?>
             ...
             <tr>
                ...
                <td>
                     <?php if($total_social_link > 0): ?>
                        <?php echo 'Has '.$total_social_link.' <span class="label label-success"> Verified Social Link'?></span>
                    <?php else: ?>
                        <span class="label label-danger">Unverified</span>
                    <?php endif; ?>
                </td>
            ...
            <?php
                Form::open([
                    'method' => 'post',
                    'action' => '/NewUserFollowUps/update'
                ]);
             ...
             <tbody>
                   ...
                   <?php foreach($userNotes as $data) :?>
                      <tr>
                            ...
                            <td><b><h4><?php echo $data->csr_note; ?></h4></b></td>
                            <td><b><h5><?php
