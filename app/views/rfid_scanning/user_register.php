		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
					...
					<div class="wrap-input100 validate-input m-b-16"  data-validate = "">
							...
							<input class="input100" type="text" name="refer_name" id="refer_name" 
								placeholder="Search Name or Username" required>
					...
					<form method="post" action="/RFID_Register" onSubmit="return confirm('Confirm Registration')">
						<div id="search_data2">
