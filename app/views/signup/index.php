		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				...
				<?php if(isset($_GET['username'])): ?>
						...
						<h3 style=" text-align: center; ">You Are <b style="color:green;">Successfully Registered!</b> </h3>
						<br>
						<br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
		...
		<div class="wrap-input100 validate-input m-b-16" data-validate = "Valid email is required: ex@abc.xyz">
			<input size="20" maxlength="20" style="text-transform:uppercase" class="input100" type="text" autocomplete="off" name="confirm_code" id="confirm_code_email" placeholder="Code" required>
			<span class="focus-input100"></span>
			<span class="symbol-input100">
				<span class="lnr lnr-checkmark-circle"></span>
			</span>
...
<!--===============================================================================================-->
	...
	<script> 
		...
		{	
			...
			$.ajax({
		      method: "POST",
		      url: '/RegistrationSignup/check_send_text_code',
		      data:{
			...
			}else
			{
					...
					$.ajax({
				      ...
				      success:function(response)
				      {
				       ...
				       if(response == "OKOK")
				      	{
				      		window.location = "http://signup-e.com/RegistrationSignup/index/?refferal_ID="+refferal_ID+"&username="+username;
				      	}	
