...
<?php include_once VIEWS.DS.'templates\users\side_bar.php' ;?>
        ...
        <!-- top navigation -->
        <?php include_once VIEWS.DS.'templates\users\top_nav.php' ;?>
        <!-- /top navigation -->

        <!-- page content -->       
        <div class="right_col" role="main" style="min-height: 524px;">
        <?php include_once VIEWS.DS.'templates\users\popups\top_notify.php' ;?> 
            ...
            <div class="x_panel">                
                <div class="x_content">   
                    ...
                    <p>&nbsp;</p>
                    <div class="x_panel well">
                        <h3 class="green"><span id="p1"><?php echo $referral_links['right'];?></span>        
                            &nbsp;&nbsp;&nbsp; 
                            <button onclick="copyToClipboard('#p1')" class="btn btn-success btn-sm">Click to Copy URL</button>
                            <script>
                                function copyToClipboard(element) {
                                    var $temp = $("<input>");
                                    $("body").append($temp);
