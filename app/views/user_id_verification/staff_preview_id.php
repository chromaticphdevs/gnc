          ...
          <section class="x_panel">
            <section class="x_content">
              ...
              <div style="overflow-x:auto;">
                 ...
                 <form action="/Users/get_qualification_notes" method="post" enctype="multipart/form-data">
                    ...
                    <input type="submit" class="btn btn-primary btn-sm validate-action" value="Send Note" id="send">
              ...
              <?php foreach ($result as $key => $value): ?>
                ...
                <h2>Status: <b> <?php echo $value->status; ?> </b></h2>
                <br>
                <br>
