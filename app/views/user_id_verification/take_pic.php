...
<script type="text/javascript" defer>
  ...
  function timeIn()
  {
    ...
    $.ajax({
      method: "POST",
      url: get_url('UserIdVerification/take_pic'),
      data:{
            ID_type:$("#type").val(),
      ...
      success:function(response)
      {
        ...
        if(returnData.status == 'success')
        {
          ...
          { 
             ...
             window.location = get_url('UserIdVerification/take_pic/?position=back&id_card_front='+returnData.id_card_front+'&type='+returnData.type);  

          }else{
            //  window.location = get_url('UserIdVerification/upload_id');   we change it for step by step verification
            
            window.location = get_url('/UserSocialMedia/add_link');  // we change it for step by step verification
             
             // /window.location = "https://m.me/YourFinancialAssistanceSpecialistCLICKHERE?ref=Change_Profile_Pic"; 
