                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach($processedLoans as $key => $row) :?>
                            ...
                            <td>
                                ...
                                <a href="/LoanProcessorVideoController/viewVideo/<?php echo seal($row->sp_id)?>">Show</a>
                                <?php else :?>
                                <a href="/LoanProcessorVideoController/addVideo/<?php echo seal($row->id)?>">Add Video</a>
                                <?php endif?>
                            </td>
                            </tr>
                        <?php endforeach?>
